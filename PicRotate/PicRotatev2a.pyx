...
#how to get smooth motion without doing that?!?!
		if i>255: #==1:  ##NB was 1 --> maybe do xes on even num, y on odds, or something/ TRY.
			b[0].x+=1
			b[1].y-=1
			b[2].y+=1
			b[3].x-=1
		...
		if i%512==256: #the actual rotation
			for k8 in xrange(4):
				for k7 in xrange(4):
					for k6 in xrange(4):
						for k5 in xrange(4):
...
#	misc.imsave('/Users/admin/testtiger-09.png',ar)
#	misc.imsave('/Users/admin/testtiger2pic.png',pic)
#	print "Done"
