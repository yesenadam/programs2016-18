...
DEF maxImageSize = 320# |322 #**** NB THIS MUST BE LARGER THAN PIC Wid & Height !! resize pics with 'sips -Z 320 *.*'
...
def OK(): #closeness factor (bigger = larger squares, and fewer).20-80 best
	...
	cdef bint found 
	fx=glob.glob("/Downloads-1/tosquare/*.png") #folder of only the png images you want to transform.
	for fn in fx:
