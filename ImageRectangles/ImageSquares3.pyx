#ImageSquares3.pyx bulk square programs..
#include "ImageSquares2.pxi"
import numpy as np
#cimport numpy
...
#	fx=["summer_flowers_bouquet-wallpaper-1280x720","sumatran-tiger_crop_0","Amazon-Rainforest-10","Amazon-Rainforest-11","Amazon-Rainforest-12","Amazon-Rainforest-2","Amazon-Rainforest-3","Amazon-Rainforest-4","Amazon-Rainforest-5","Amazon-Rainforest-6","Amazon-Rainforest-7","Amazon-Rainforest-8","Amazon-Rainforest-9","Santorini-Greece-1-1","Santorini-Greece-10","Santorini-Greece-2-1","Santorini-Greece-3-1","Santorini-Greece-4-1","Santorini-Greece-5-1","Santorini-Greece-6-1","Santorini-Greece-7-1","Santorini-Greece-8-1","Santorini-Greece","fantastic_china-wallpaper-1280x720","feel_the_moment-wallpaper-1280x720","fishers_in_the_boat-wallpaper-1280x720","forest_stream_2-wallpaper-1280x720","grace-wallpaper-1280x720","green_mile-wallpaper-1280x720","green_wood_3-wallpaper-1280x720","rainforest-t2","rainforest-wallpaper-1600x1200","rainforest1-250x195","rainforest1","sunflowers-wallpaper-1280x720","sunset_5-wallpaper-1280x720","waterfall_13-wallpaper-1280x720","whistler_coast_mountains_dock-wallpaper-1280x720"]
...
#,"rainforest1-250x195","rainforest1","sunflowers-wallpaper-1280x720","sunset_5-wallpaper-1280x720","waterfall_13-wallpaper-1280x720","whistler_coast_mountains_dock-wallpaper-1280x720"]
	for na in fx:#na="/Downloads-1/newpicssmall/summer_flowers_bouquet-wallpaper-1280x720"# #just change this one
		tally=0
		ext=".png"
		fn="/Downloads-1/newpicssmall/"+na+ext
		name="/Downloads-1/newpicssmall/"+na+"-%d" % close+ext #saves under this name, e.g. room-180.png
